...
return (
    ...
    <main className="flex flex-col gap-6 row-start-2 items-start max-w-3xl w-full">
        <h1 className="text-4xl sm:text-6xl font-bold">Privacy Policy</h1>
        ...
        <p className="text-lg sm:text-xl">
        I does not store any user-identifiable data anywhere outside your device.
        </p>
        <p className="text-lg sm:text-xl">
